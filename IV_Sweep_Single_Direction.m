function [timestamp,voltage,currentDensity,pdCurrent] = IV_Sweep_Single_Direction
...
delay = 0; % sec; delay between change voltage, measure current
...
beginToEndpoint = transpose(beginVoltage:voltageStepSize:endpointVoltage);

% build multiple cycles
trackingvoltage = repmat(beginToEndpoint,sweeps,1);
